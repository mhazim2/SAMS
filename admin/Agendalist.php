		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Ageda List</a>
                </div>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
																			...
																			if(mysqli_num_rows($query) == 0){	//ini artinya jika data hasil query di atas kosong
																				...
																				while($data = mysqli_fetch_assoc($query)){	//perulangan while dg membuat variabel $data yang akan mengambil data di database
																					...
																					echo '<tr>';
																						...
																						echo '<td>'.$data['id_user_agenda'].'</td>';
																						echo '<td>'.$data['id_friend'].'</td>';
                                                    ...
                                                    <form class="" action="gethapusagenda.php?id='.$data['id_agenda'].'"" method="post">
